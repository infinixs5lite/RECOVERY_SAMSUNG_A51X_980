...
tar -xJf device/samsung/a51x/source_changes/bootable.tar.xz -C bootable/recovery
cd bootable/recovery
patch -p1 < ../../device/samsung/a51x/colour_fix.diff
cd ../../
...
# MKBOOTIMG
chmod a+x device/samsung/a51x/prebuilt/mkboot/mkbootimg
...
SRC="device/samsung/a51x/source_changes/maintainer/processed_image1.png"
...
export FOX_TARGET_DEVICES="a51x"

# Function to export build variables
export_build_vars() {
    echo -e "${GREEN}Exporting build vars from the a51x tree${RESET}"
